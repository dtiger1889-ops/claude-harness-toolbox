...
- **A 631-session transcript crawl** grounded the skill suite. The expected friction,
  "I'm overwhelmed, simplify," barely showed up. What kept showing up was laziness: the
  model stopping at "can't determine" with the data one step away, or describing what it
  could do instead of doing it. The skills target the problem the transcripts actually
  proved. Crawl your own before you copy this tool list.
